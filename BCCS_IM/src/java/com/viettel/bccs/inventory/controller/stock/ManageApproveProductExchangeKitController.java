...
@Component
@Scope("view")
@ManagedBean(name = "manageApproveProductExchangeKitController")
public class ManageApproveProductExchangeKitController extends TransCommonController {
    ...
    public void doSearch() {
        try {
            searchInputDTO.setRequestType(Const.CHANGE_MODEL_TRANS_REQUEST_TYPE.CREATE_REQUEST_KIT);
    ...
    @Secured("@")
    public void doValidate(Long changeModelTransId) {
        try {
    ...
    @Secured("@")
    public void doValidateCancel(Long changeModelTransId) {
        this.changeModelTransId = changeModelTransId;
//            if (writeOffice) {
//                signOfficeDTO = writeOfficeTag.validateVofficeAccount();
//            }
...
//            changeModelTransService.approveChangeProduct(changeModelTransId, staffDTO, stockTransDTO, requiredRoleMap);
            changeModelTransService.approveChangeProductKit(changeModelTransId, staffDTO.getStaffId(), stockTransDTO, requiredRoleMap);
