 ...
 */
@Entity
@Table(name = "STOCK_TOTAL_AUDIT",schema = "BCCS_IM")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "StockTotalAuditIm1.findAll", query = "SELECT s FROM StockTotalAudit s")})
public class StockTotalAuditIm1 implements Serializable {
public static enum COLUMNS {OWNERID, OWNERCODE, OWNERNAME, OWNERTYPE, USERID, USERCODE, USERNAME, STATEID, STOCKMODELID, STOCKMODELNAME,
    CREATEDATE, STATUS, QTY, QTYISSUE, QTYHANG, QTYBF, QTYISSUEBF, QTYHANGBF, QTYAF, QTYISSUEAF, QTYHANGAF, TRANSID, TRANSCODE, TRANSTYPE,
    SOURCETYPE, STICKCODE, REASONNAME, REASONID, DESCRIPTION, SHOPIDLV1, SHOPCODELV1, SHOPNAMELV1, SHOPIDLV2, SHOPCODELV2, SHOPNAMELV2,
    SHOPIDLV3, SHOPCODELV3, SHOPNAMELV3, SHOPIDLV4, SHOPCODELV4, SHOPNAMELV4, SHOPIDLV5, SHOPCODELV5, SHOPNAMELV5, SHOPID, SHOPCODE,
    SHOPNAME, SHOPIDLV6, SHOPCODELV6, SHOPNAMELV6, SYNSTATUS, STOCKMODELCODE, STOCKTYPEID, VALID, EXCLUSE_ID_LIST};
    ...
    @Column(name = "QTY")
    private Long qty;
    @Column(name = "QTY_ISSUE")
    private Long qtyIssue;
    @Column(name = "QTY_HANG")
    private Long qtyHang;
    @Column(name = "QTY_BF")
    private Long qtyBf;
    @Column(name = "QTY_ISSUE_BF")
    private Long qtyIssueBf;
    @Column(name = "QTY_HANG_BF")
    private Long qtyHangBf;
    @Column(name = "QTY_AF")
    private Long qtyAf;
    @Column(name = "QTY_ISSUE_AF")
    private Long qtyIssueAf;
    @Column(name = "QTY_HANG_AF")
    ...
    public StockTotalAuditIm1() {
    }

    public StockTotalAuditIm1(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StockTotalAuditIm1)) {
            return false;
        }
        StockTotalAuditIm1 other = (StockTotalAuditIm1) object;
