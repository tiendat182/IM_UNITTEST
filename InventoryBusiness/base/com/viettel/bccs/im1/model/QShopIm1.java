...
public class QShopIm1 extends EntityPathBase<ShopIm1> {

    private static final long serialVersionUID = 1503401800L;

    public static final QShopIm1 shop1 = new QShopIm1("shop1");
    ...
    public QShopIm1(String variable) {
        super(ShopIm1.class, forVariable(variable));
    }

    public QShopIm1(Path<? extends ShopIm1> path) {
        super(path.getType(), path.getMetadata());
    }

    public QShopIm1(PathMetadata<?> metadata) {
        super(ShopIm1.class, metadata);
    }
