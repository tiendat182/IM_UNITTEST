...
public class QStaffIm1 extends EntityPathBase<StaffIm1> {

    private static final long serialVersionUID = -1978206513;

    public static final QStaffIm1 staff = new QStaffIm1("staff");
    ...
    public QStaffIm1(String variable) {
        super(StaffIm1.class, forVariable(variable));
    }

    public QStaffIm1(Path<? extends StaffIm1> entity) {
        super(entity.getType(), entity.getMetadata());
    }

    public QStaffIm1(PathMetadata<?> metadata) {
        super(StaffIm1.class, metadata);
    }
