 ...
 */
@Entity
@Table(name = "BCCS_IM.PAYMENT_DEBIT")
public class PaymentDebitIm1 implements Serializable {
    ...
    @SequenceGenerator(name = "PAYMENT_DEBIT_IM1_ID_GENERATOR", sequenceName = "BCCS_IM.PAYMENT_DEBIT_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PAYMENT_DEBIT_IM1_ID_GENERATOR")
    ...
    public PaymentDebitIm1() {
    }

    public PaymentDebitIm1(Long paymentDebitId) {
        this.paymentDebitId = paymentDebitId;
    }

    public PaymentDebitIm1(Long paymentDebitId, Long paymentGroupId, Long ownerId, Long ownerType) {
        this.paymentDebitId = paymentDebitId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PaymentDebitIm1)) {
            return false;
        }
        PaymentDebitIm1 other = (PaymentDebitIm1) object;
