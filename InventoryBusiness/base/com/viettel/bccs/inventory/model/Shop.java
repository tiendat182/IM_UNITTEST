...
public class Shop implements Serializable {
    ...
    @Column(name = "SHOP_KEEPER_ID")
    private Long shopKeeperId;
    @Column(name = "SHOP_DIRECTOR_ID")
    ...
    public Shop(Long shopId, String name, String shopCode, Long channelTypeId) {
        this.shopId = shopId;
        this.name = name;
    ...
    public String toString() {
        return "com.viettel.bccs.sale.model.Shop[ shopId=" + shopId + " ]";
    }
