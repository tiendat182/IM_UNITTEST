...
@NamedQueries(value = {
        @NamedQuery(name = "StockTransDetail.findAll", query = "SELECT s FROM StockTransDetail s")})
...
public static enum COLUMNS {AMOUNT, CREATEDATETIME, PRICE, PRODOFFERID, QUANTITY, STATEID, STOCKTRANSDETAILID, STOCKTRANSID, EXCLUSE_ID_LIST};
    ...
    @SequenceGenerator(name = "STOCK_TRANS_DETAIL_ID_GENERATOR", sequenceName = "STOCK_TRANS_DETAIL_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "STOCK_TRANS_DETAIL_ID_GENERATOR")
    ...
    @Column(name = "PROD_OFFER_ID_SWAP")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StockTransDetail)) {
            return false;
        }
        StockTransDetail other = (StockTransDetail) object;
