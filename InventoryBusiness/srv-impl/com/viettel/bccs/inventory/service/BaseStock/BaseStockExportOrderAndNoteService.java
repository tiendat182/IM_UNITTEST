...
@Service
public class BaseStockExportOrderAndNoteService extends BaseStockService {
    ...
    public StockTransActionDTO executeStockTrans(StockTransDTO stockTransDTO, StockTransActionDTO stockTransActionDTO, List<StockTransDetailDTO> lstStockTransDetail, RequiredRoleMap requiredRoleMap) throws Exception {
        ...
        //lap lenh
        StockTransActionDTO orderTransActionDTO = baseStockOutOrderService.executeStockTrans(stockTransDTOTmp, stockTransActionDTO, lstStockTransDetail, requiredRoleMap);
        ...
        StockTransActionDTO noteTransActionDTO = baseStockNoteOrderService.executeStockTrans(stockTransDTO, orderTransActionDTO, lstStockTransDetail, requiredRoleMap);
