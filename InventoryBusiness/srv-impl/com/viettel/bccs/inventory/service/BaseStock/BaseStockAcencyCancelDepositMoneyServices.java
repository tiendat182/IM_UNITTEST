...
/**
 * Created by HungPM6 on 2/1/2016.
 */
@Service
public class BaseStockAcencyCancelDepositMoneyServices extends BaseStockService{



    public static final Logger logger = Logger.getLogger(BaseStockAcencyCancelDepositMoneyServices.class);
...
//        flagStockDTO.setReceiptExpenseStatus(Const.STOCK_TRANS.STOCK_TRANS_DEPOSIT);
        flagStockDTO.setDepositStatus(Const.STOCK_STRANS_DEPOSIT.DEPOSIT_CANCEL);
