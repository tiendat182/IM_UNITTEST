...
public class CommandLinkRenderer extends CoreRenderer {
    ...
    public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
        ...
        if (!link.isDisabled()) {
            ...
            MethodExpression methodExpression = link.getActionExpression();
            if (methodExpression == null) {
                javax.faces.event.ActionListener[] actionListeners = link.getActionListeners();
                ...
                if (resourceBundle != null) {
                    ...
                    try {
                        ...
                        if (kpiParamValue != null) {
                            ...
                            link.getChildren().add(uiParameter);
                        }
