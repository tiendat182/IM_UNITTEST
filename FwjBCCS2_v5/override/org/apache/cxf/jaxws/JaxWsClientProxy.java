...
/*
20151217: thiendn1: ghi de lai lib cxf de tu reset method khi dung jrebel
 */
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (oi == null) {
            try{
                ...
                CxfWsClientFactory cxfWsClientFactory = context.getBean(CxfWsClientFactory.class);
                client = (Client) cxfWsClientFactory.createWsClient((Class) endpoint.getService().get("endpoint.class"));
                return method.invoke(client, params);
            }
            catch(Exception e){
