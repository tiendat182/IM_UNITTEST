...
public class LoginBean implements Serializable {
    ...
    private List<GrantedAuthorityPassport> authoLstCache;
    ...
    public void init() {
        try {
            ...
            loginDate = Faces.getSessionAttribute(CustomConnector.LOGIN_DATE);
    ...
    public String getChatUrl() {
        return "";
//        return CustomConnector.rb != null ? DataUtil.safeToString(CustomConnector.rb.getString("chatUrl")) : "";
    }

    public String getChatDomain() {
        return "";
//        return CustomConnector.rb != null ? DataUtil.safeToString(CustomConnector.rb.getString("chatDomain")) : "";
    }
