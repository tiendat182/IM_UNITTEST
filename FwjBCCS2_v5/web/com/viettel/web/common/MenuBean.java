...
/**
 * Created by vtsoft on 4/21/2015.
 */
@ManagedBean
@Component
@Scope("session")
public class MenuBean implements Serializable {
    ...
    final String URL_SPLIT = "/";
    final String HOME_URL = "/home";
    ...
    public void createSaleMenuModel() {
        ...
        allowUrl = (List<String>)Faces.getSessionAttribute(Const.VSA_ALLOW_URL);
    ...
    public void addMenuToken(ObjectToken menuToken, DefaultSubMenu subMenu, int countParent) {
        if (menuToken.getChildObjects().isEmpty()) {
            ...
            boolean isDisable = !DataUtil.isNullOrEmpty(allowUrl) && !allowUrl.contains(menuToken.getObjectUrl());
            item.setDisabled(isDisable);
            item.setStyle(isDisable ? "color: gray" : "");
