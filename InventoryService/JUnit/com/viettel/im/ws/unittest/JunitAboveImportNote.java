...
public class JunitAboveImportNote{
    @Autowired
    ...
    public void testValidate_stockFromOwnerNotNull() {
        try {
            ...
            baseStockInNoteService.executeStockTrans(stockTransDTO, stockTransActionDTO, lstStockTransDetailDTO, requiredRoleMap);
...
//            initListStockTransDetailDTO();
            initStockTransAction();
            stockTransActionDTO.setActionCode("PN_CN_HNI2_THAONT19_000043");
    ...
    public void test_stockTransDetailNull() {
        try {
            ...
            baseStockInNoteService.executeStockTrans(stockTransDTO, stockTransActionDTO, null, requiredRoleMap);
        } catch (LogicException lex) {
            String desc = lex.getDescription();
