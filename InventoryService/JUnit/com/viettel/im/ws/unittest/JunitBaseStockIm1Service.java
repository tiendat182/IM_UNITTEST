...
public class JunitBaseStockIm1Service{
    ...
    @Autowired
    StockTotalIm1Service stockTotalIm1Service;
...
//        stateId = "1";
    ...
    @Test
    public void tesBaseStockIm1Service() {
        try {
            initStockTransDTO();
            initListStockTransDetailDTO();
            initStockTransAction();
//            baseStockIm1Service.doSaveStockTotal(stockTransDTO,lstStockTransDetailDTO,new FlagStockDTO(),stockTransActionDTO);
            StockModelIm1DTO stockModelIm1DTO = stockTotalIm1Service.findOneStockModel(1117L);
            System.out.println(stockModelIm1DTO.getStatus());
